...
C     
C     Process: e+ e- > ta+ ta- WEIGHTED<=4 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $     *small_width_treatment)), mdl_WZ) 
      ...
      CALL FFV1P0_3(W(1,3),W(1,2),GC_3,ZERO,FK_ZERO,W(1,9))  !  count 4
      CALL FFV1P0_3(W(1,4),W(1,1),GC_3,ZERO,FK_ZERO,W(1,10))  !  count 4
      CALL FFV1P1N_1(W(1,7), W(1,9), GC_3, TMP(1))
      call CombineAmp(2,
     & (/2,4/), 
     & (/5,6/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,7), W(1,10), GC_3, TMP(1))
      call CombineAmp(2,
     & (/6,8/), 
     & (/5,6/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,8), W(1,9), GC_3, TMP(1))
      call CombineAmp(2,
     & (/1,3/), 
     & (/5,6/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,8), W(1,10), GC_3, TMP(1))
      call CombineAmp(2,
     & (/5,7/), 
     & (/5,6/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_4_3(W(1,3),W(1,2),GC_50,GC_59,MDL_MZ,FK_MDL_WZ,W(1,11))  !  count 4
      CALL FFV2_4_3(W(1,4),W(1,1),GC_50,GC_59,MDL_MZ,FK_MDL_WZ,W(1,12))  !  count 4
      CALL FFV2_4P1N_1(W(1,7), W(1,11), GC_50, GC_59, TMP(1))
      call CombineAmp(2,
     & (/2,4/), 
     & (/5,6/),
     & TMP, W, AMP(1,2))
      CALL FFV2_4P1N_1(W(1,7), W(1,12), GC_50, GC_59, TMP(1))
      call CombineAmp(2,
     & (/6,8/), 
     & (/5,6/),
     & TMP, W, AMP(1,2))
      CALL FFV2_4P1N_1(W(1,8), W(1,11), GC_50, GC_59, TMP(1))
      call CombineAmp(2,
     & (/1,3/), 
     & (/5,6/),
     & TMP, W, AMP(1,2))
      CALL FFV2_4P1N_1(W(1,8), W(1,12), GC_50, GC_59, TMP(1))
      call CombineAmp(2,
     & (/5,7/), 
     & (/5,6/),
