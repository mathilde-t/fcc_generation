...
C     
C     Process: e+ e- > mu+ mu- WEIGHTED<=4 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $     *small_width_treatment)), mdl_WZ) 
      ...
      CALL FFV1P0_3(W(1,3),W(1,2),GC_3,ZERO,FK_ZERO,W(1,9))  !  count 2
      CALL FFV1P0_3(W(1,4),W(1,1),GC_3,ZERO,FK_ZERO,W(1,10))  !  count 2
      ...
      CALL FFV2_4_3(W(1,3),W(1,2),GC_50,GC_59,MDL_MZ,FK_MDL_WZ,W(1,11))  !  count 2
      CALL FFV2_4_3(W(1,4),W(1,1),GC_50,GC_59,MDL_MZ,FK_MDL_WZ,W(1,12))  !  count 2
