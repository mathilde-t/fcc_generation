...
C     
C     Generated by MadGraph5_aMC@NLO v. 3.5.9, 2025-06-04
...
C     
C     Process: e+ e- > e+ e- WEIGHTED<=4 $ z @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $     *small_width_treatment)), mdl_WZ) 
      ...
      CALL OXXXXX(P(0,1),ZERO,-1,-1*IC(1),W(1,2))  !  count 8
      ...
      CALL FFV1P0_3(W(1,3),W(1,1),GC_3,ZERO,FK_ZERO,W(1,9))  !  count 1
      CALL FFV1P0_3(W(1,3),W(1,2),GC_3,ZERO,FK_ZERO,W(1,10))  !  count 2
      CALL FFV1P0_3(W(1,4),W(1,1),GC_3,ZERO,FK_ZERO,W(1,11))  !  count 2
      CALL FFV1P0_3(W(1,4),W(1,2),GC_3,ZERO,FK_ZERO,W(1,12))  !  count 1
      CALL FFV1_0(W(1,5),W(1,7),W(1,9),GC_3,AMP(4,1))
      CALL FFV1P1N_3(W(1,5), W(1,8), GC_3, TMP(1))
      call CombineAmp(2,
     & (/1,5/), 
     & (/10,11/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_3(W(1,6), W(1,7), GC_3, TMP(1))
      call CombineAmp(2,
     & (/2,6/), 
     & (/10,11/),
     & TMP, W, AMP(1,1))
      CALL FFV1_0(W(1,6),W(1,8),W(1,12),GC_3,AMP(3,1))  !  count 1
      CALL FFV2_4_3(W(1,3),W(1,1),GC_50,GC_59,MDL_MZ,FK_MDL_WZ,W(1,13))  !  count 1
      CALL FFV2_4_3(W(1,3),W(1,2),GC_50,GC_59,MDL_MZ,FK_MDL_WZ,W(1,14))  !  count 2
      CALL FFV2_4_3(W(1,4),W(1,1),GC_50,GC_59,MDL_MZ,FK_MDL_WZ,W(1,15))  !  count 2
      CALL FFV2_4_3(W(1,4),W(1,2),GC_50,GC_59,MDL_MZ,FK_MDL_WZ,W(1,16))  !  count 1
      CALL FFV2_4_0(W(1,5),W(1,7),W(1,13),GC_50,GC_59,AMP(4,2))
      CALL FFV2_4P1N_3(W(1,5), W(1,8), GC_50, GC_59, TMP(1))
      call CombineAmp(2,
     & (/1,5/), 
     & (/14,15/),
     & TMP, W, AMP(1,2))
      CALL FFV2_4P1N_3(W(1,6), W(1,7), GC_50, GC_59, TMP(1))
      call CombineAmp(2,
     & (/2,6/), 
     & (/14,15/),
     & TMP, W, AMP(1,2))
      CALL FFV2_4_0(W(1,6),W(1,8),W(1,16),GC_50,GC_59,AMP(3,2))  !  count 1
      CALL FFV1P0_3(W(1,5),W(1,1),GC_3,ZERO,FK_ZERO,W(1,17))  !  count 2
      CALL FFV1P0_3(W(1,5),W(1,2),GC_3,ZERO,FK_ZERO,W(1,18))  !  count 1
      CALL FFV1P0_3(W(1,6),W(1,1),GC_3,ZERO,FK_ZERO,W(1,19))  !  count 1
      CALL FFV1P0_3(W(1,6),W(1,2),GC_3,ZERO,FK_ZERO,W(1,20))  !  count 2
      CALL FFV1P1N_3(W(1,3), W(1,7), GC_3, TMP(1))
      call CombineAmp(2,
     & (/4,2/), 
     & (/17,20/),
     & TMP, W, AMP(1,3))
      CALL FFV1_0(W(1,3),W(1,8),W(1,18),GC_3,AMP(1,3))
      CALL FFV1_0(W(1,4),W(1,7),W(1,19),GC_3,AMP(6,3))
      CALL FFV1P1N_3(W(1,4), W(1,8), GC_3, TMP(1))
      call CombineAmp(2,
     & (/5,3/), 
     & (/17,20/),
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFV2_4_3(W(1,5),W(1,1),GC_50,GC_59,MDL_MZ,ZERO,W(1,21))  !  count 2
      CALL FFV2_4_3(W(1,5),W(1,2),GC_50,GC_59,MDL_MZ,ZERO,W(1,22))  !  count 1
      CALL FFV2_4_3(W(1,6),W(1,1),GC_50,GC_59,MDL_MZ,ZERO,W(1,23))  !  count 1
      CALL FFV2_4_3(W(1,6),W(1,2),GC_50,GC_59,MDL_MZ,ZERO,W(1,24))  !  count 2
      CALL FFV2_4P1N_3(W(1,3), W(1,7), GC_50, GC_59, TMP(1))
      call CombineAmp(2,
     & (/4,2/), 
     & (/21,24/),
     & TMP, W, AMP(1,4))
      CALL FFV2_4_0(W(1,3),W(1,8),W(1,22),GC_50,GC_59,AMP(1,4))
      CALL FFV2_4_0(W(1,4),W(1,7),W(1,23),GC_50,GC_59,AMP(6,4))
      CALL FFV2_4P1N_3(W(1,4), W(1,8), GC_50, GC_59, TMP(1))
      call CombineAmp(2,
     & (/5,3/), 
     & (/21,24/),
...
C       JAMPs contributing to orders ALL_ORDERS=1
     ...
     $  00D +00)*AMP( K,2)+AMP( K,3)+AMP( K,4)
